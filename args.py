...
def parse_args():
    ...
    parser.add_argument('--AugDegree', type=int, default=2, help='1 for only GraphSHA degree, 2 for in and out degree')
    parser.add_argument('--withAug', type=bool, default=True, help='True is with GraphSHA, else without')

    # parser.add_argument('--device', type=str, default='cuda:0', help='device')
    parser.add_argument('--seed', type=int, default=100, help='seed')
    parser.add_argument('--dataset', type=str, choices=['Cora', 'CiteSeer', 'PubMed', 'Amazon-Photo', 'Amazon-Computers', 'Coauthor-CS'], default='Coauthor-CS', help='dataset name')
    parser.add_argument('--data_path', type=str, default='datasets/', help='data path')
    parser.add_argument('--imb_ratio', type=float, default=100, help='imbalance ratio')
    parser.add_argument('--net', type=str, choices=['GCN', 'GAT', 'SAGE'], default='GCN', help='GNN backbone')
